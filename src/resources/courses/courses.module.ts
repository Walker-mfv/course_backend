...
import { CoursesClientController } from './controllers/client-courses.controller'
...
@Module({
  ...
  providers: [CoursesService, FormCourseService, ClientCoursesService, InstructorCoursesService, AcpCoursesService],
