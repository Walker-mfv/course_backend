...
export class UserLearningController {
  constructor(private readonly usersService: UsersService, private readonly userCourseService: UserCourseService) {}
  ...
  uncompletedLecture(@Param('userCourseId') userCourseId: string, @Param('unitId') unitId: string) {
