...
export class ActivityLogsService extends BaseModel<ActivityLog, ActivityLogDocument> {
  protected searchFields: string[] = ['user.email', 'user.profile.fullName', 'content', 'deviceInfo.ip']
  ...
  protected displayFields: string[] = ['_id', 'user', 'deviceInfo', 'content', 'domain', 'timestamp']
