...
import { BASIC_PERMISSIONS, TDocumentName, TPermission } from './../common/utils/constants/role.constant'
...
export class CaslAbilityFactory {
  ...
  private setPermissions(can: any, documentName: TDocumentName, permissions: TPermission[], onlyForCreator: boolean) {
